...
"font: 75 22pt \"MS Shell Dlg 2\";")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox__bod_recibe.setItemText(0, _translate("MainWindow", "Bodega Principal"))
        self.comboBox__bod_recibe.setItemText(1, _translate("MainWindow", "Bodega 1"))
        self.comboBox__bod_recibe.setItemText(2, _translate("MainWindow", "Bodega 2"))
        self.comboBox__bod_recibe.setItemText(3, _translate("MainWindow", "Bodega 3"))
        ...
        self.comboBox_distrib_recibe_3.setItemText(0, _translate("MainWindow", "Bodega Principal"))
        self.comboBox_distrib_recibe_3.setItemText(1, _translate("MainWindow", "Bodega 1"))
        self.comboBox_distrib_recibe_3.setItemText(2, _translate("MainWindow", "Bodega 2"))
        self.comboBox_distrib_recibe_3.setItemText(3, _translate("MainWindow", "Bodega 3"))
        ...
        self.comboBox_bod_saldos.setItemText(0, _translate("MainWindow", "Bodega Principal"))
        self.comboBox_bod_saldos.setItemText(1, _translate("MainWindow", "Bodega 1"))
        self.comboBox_bod_saldos.setItemText(2, _translate("MainWindow", "Bodega 2"))
        self.comboBox_bod_saldos.setItemText(3, _translate("MainWindow", "Bodega 3"))
